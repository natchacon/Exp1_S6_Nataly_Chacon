...
public class TeatroMoro {
    ...
    public static void imprimirBoleta(String tipoEntrada, String asientoSeleccionado){
        ...
        if(indiceCompra!=-1){
         ...
         System.out.println("Tipo Entrada " + entrada[0]);
         ...
         System.out.println("Precio pagado " + entrada[4]);
         System.out.println("\r\r");
        }
    ...
    public static void mostrarCompras(){
         ...
         for(int i=0;i<entradasCompradas.size();i++){
            String[] entrada = (String[])entradasCompradas.get(i); 
            System.out.println("Entrada " + entrada[0] + " asiento "+ entrada[1] + " precio base " + entrada[2] + " descuento aplicado " + entrada[3] + " precio pagado " + entrada[4]);
    ...
    public static void comprarEntrada(){
        ...
        if(asiento!=null){
            ...
            String[] entrada={tipoEntrada, numeroAsiento, String.valueOf(precioBase), descuento, String.valueOf(tarifaACobrar)};
